...
export type FAQCategory = "pricing" | "plans" | "websites";

export const faqsByCategory: Record<FAQCategory, FAQItem[]> = {
  pricing: [
    {
      id: "pricing-deposit",
...
export const allFaqs = Object.values(faqsByCategory).flat();
